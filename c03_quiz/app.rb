...
before do
    ...
    @questions = Array.new
    @questions.push(["Webサービスプログラムコースで学んでいる、赤色の宝石の名前を使っている言語は？","Garnet","Ruby","Amethyst","Opal","2"])
    @questions.push(["Life is Tech!でプログラミングを教えてくれるのはだれ？","メンバー","センセー","メンター","センサー","3"])
end
